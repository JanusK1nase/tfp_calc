...
def inside_out():
    if species in ["fel" , "feline" , "cat", "c"]:
        if weight < 3:
            ...
            insideoutgive = "1"
        insideoutprint = (f"In-sideout: \nMix {insideoutgive} scoop with food daily as a supplement. May be divided between breakfast and dinner. \n ")
    else:
        if weight < 3:
            insideoutgive = "1/2"
        elif weight < 10:
            ...
            insideoutgive = "4"
        insideoutprint = (f"In-sideout: \nMix {insideoutgive} scoop/s with food daily as a supplement. May be divided between breakfast and dinner. \n ")
...
def sildenafil():
    ...
    if sildegive_2 == 0.25:
        ...
        st.write (f"Please check patient's weight and dosage, the drug may require compounding: {silde_comp_dsg:.1f}mg") 
